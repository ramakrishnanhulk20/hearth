 ...
 */
// Hearth's own errors sit alongside the protocol's because a live RPC returns raw revert data,
// where the local provider had already decoded it against the contract's interface.
const PROTOCOL_ERRORS = new Interface([
  ...
  "error WrongStatus(uint32 drawId, uint8 status)",
