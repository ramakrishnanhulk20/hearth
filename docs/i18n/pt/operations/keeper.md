...
`packages/keeper/ecosystem.config.cjs` sobe todos os sete sob o pm2, um processo cada. Um
processo sabe qual pool conduz pelo `HEARTH_ADDRESSES_FILE`, o arquivo de endereços que a
