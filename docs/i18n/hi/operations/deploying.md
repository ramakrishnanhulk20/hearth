...
| `NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID` | हाँ | वैकल्पिक, और Reown के डैशबोर्ड https://dashboard.reown.com से मुफ़्त मिलता है। इसे सेट कीजिए और हर कनेक्ट स्क्रीन ब्राउज़र एक्सटेंशन के बगल में "फ़ोन से स्कैन कीजिए" भी देती है, जिससे फ़ोन वाला वॉलेट और वह मशीन जिस पर कोई एक्सटेंशन नहीं है, दोनों अंदर आ पाते हैं। खाली छोड़ने पर कनेक्टर बनता ही नहीं, इसलिए किसी को ऐसा बटन नहीं दिया जाता जो स्कैन करते ही नाकाम हो जाए |
