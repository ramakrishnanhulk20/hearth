...
Updated 3 September 2026, end of milestone 1.
...
- Deploy script, Sepolia config, seed, status, draw and prove-it tasks (in progress).
- Fairness and invariant tests (in progress).
- Static analysis, Sepolia deployment and verification, seeding, live draws by the keeper,
  prove-it output, self-audit with executed attack scripts.
